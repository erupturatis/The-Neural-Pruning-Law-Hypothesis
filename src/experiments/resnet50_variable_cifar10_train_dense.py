...
def train_dense_resnet50_cifar10(model: ModelResnet50Variable) -> ModelResnet50Variable:
    ...
    save_model_entire_dict(model, f"resnet50_cifar10_alpha{model.alpha}_acc{acc:.1f}", BASELINE_MODELS_PATH)
