...
def train_dense_vgg19_cifar100(model: ModelVGG19Variable) -> ModelVGG19Variable:
    ...
    save_model_entire_dict(model, f"vgg19_cifar100_alpha{model.alpha}_acc{acc:.1f}", BASELINE_MODELS_PATH)
